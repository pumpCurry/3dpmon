...
- Gate 18.9 Universal MaterialSource accounting は、K1/K2を別会計にせず
  ...
  canonical locator/identity validation、provisional rekey boundary、open mount最大1、
  close lifecycle、operation idempotency、interval overlap conflictを固定しながら、永続化やcutoverへ段階的に接続する。
