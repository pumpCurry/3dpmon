/**
 * @fileoverview
 * XY/Z プレビュー表示を管理するモジュール。
 *
 * - XY履歴の保存・復元を行い、任意角度からのステージ描画を提供します。
 */
...
/**
 * XYプレビューの状態を localStorage へ保存します。
 *
 * @returns {void}
 */
 ...
 * XY プレビューを更新します。
 *
 * @param {number} x - 現在位置 X(mm)
 * @param {number} y - 現在位置 Y(mm)
 * @returns {void}
 */
