...
- **K2/CFS print authority**: explicit CFS print starts now pass through the production command dispatcher, with send-time session, certified transport profile, file identity, fresh loaded-slot, and material type/color revalidation before any `colorMatch` / `multiColorPrint` frame is sent.
...
- 検証: targeted K2/CFS command/material UI tests 81件PASS、full Vitest 98 files / 1547 tests PASS、
